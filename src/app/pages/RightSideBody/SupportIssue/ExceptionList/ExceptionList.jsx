...
export default function ExceptionList() {
  ...
  const [btnsonDelete, setBtnsonDelete] = React.useState(false);
  const [btnsonDownload, setBtnsonDownload] = React.useState(false);
  ...
  const handleClose = () => {
    setOpen(false);
    setBtnsonDelete(false);
    setBtnsonDownload(false);
  };

  const handleDelete = () => {
    setBtnsonDelete(true);
    setBtnsonDownload(false);
  };

  const handleDownload = () => {
    setBtnsonDownload(true);
    setBtnsonDelete(false);
  };
